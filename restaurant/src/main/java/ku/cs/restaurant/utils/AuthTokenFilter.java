...
public class AuthTokenFilter extends OncePerRequestFilter {
    ...
    static {
        ...
        uriRoleMap.put("/order", new HashSet<>(Arrays.asList("RIDER", "ADMIN", "CUSTOMER")));
        uriRoleMap.put("/recipe", new HashSet<>(Arrays.asList("RIDER", "ADMIN")));
        uriRoleMap.put("/user", new HashSet<>(Arrays.asList("RIDER", "ADMIN", "CUSTOMER")));
        uriRoleMap.put("/foods", new HashSet<>(Arrays.asList("RIDER", "CUSTOMER", "ADMIN")));
        uriRoleMap.put("/order_line", new HashSet<>(Arrays.asList("RIDER", "CUSTOMER", "ADMIN")));
        uriRoleMap.put("/receipt", new HashSet<>(Arrays.asList("RIDER", "CUSTOMER", "ADMIN")));
        ...
        uriRoleMap.put("/promotions", new HashSet<>(Arrays.asList("ADMIN", "CUSTOMER")));
    }
